...
void SofaEntity::updateGraph()
{
    ...
    if(mySofaScene->sofaRootNode())
    {
        ...
        //Qt3DRender::QGeometryRenderer* geometryRenderer = new Qt3DRender::QGeometryRenderer(this);
        //Qt3DRender::QGeometry* geometry = new Qt3DRender::QGeometry(geometryRenderer);

        //Qt3DRender::QBuffer *m_vertexDataBuffer = new Qt3DRender::QBuffer(Qt3DRender::QBuffer::VertexBuffer, this);
        //Qt3DRender::QBuffer *m_indexDataBuffer = new Qt3DRender::QBuffer(Qt3DRender::QBuffer::VertexBuffer, this);
        ...
        //// 4 faces of 3 points
        //geometryRenderer->setVertexCount(12);

        //this->addComponent(geometryRenderer);
        //this->addComponent(torusTransform);
